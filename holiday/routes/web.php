...
// Logout
Route::match(['get', 'post'], '/logout', $namespace.'\TourControllerEventmieController@logout')->name('eventmie.logout');
...
Route::prefix('/touroperator')->group(function () use ($namespace) {
    ...
    Route::get('loginmy', "$tourcontroller@loginmy")->name('loginmy');
...
Route::group([
    ...
    Route::prefix('/trips')->group(function () use ($namespace) {
        ...
        Route::get('/city', "$tripcontroller@cityindex")->name('city_index');
        Route::post('rvsp', "$tripcontroller@rvsp")->name('rvsp');

        Route::get('bookingjs/{id}',"$tripcontroller@bookingjs")->name('bookingjs');
