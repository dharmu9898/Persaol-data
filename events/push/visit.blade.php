...
@extends('eventmie::layouts.apps')

{{-- Page title --}}
@section('title')
    @lang('eventmie-pro::em.my_dashboard')
@endsection
<style>
.myimg {
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-12 ml-auto">
        <div class="row align-items-center">
            <div class="col-xl-12 col-12 mb-4 mb-xl-0">
                <div class="container-fluid  mt-5 card  border-primary border-primary-5 mb-3">
                    <div class="row card-body">
                        <div class="col-xl-4 ">
                            <p class="button py-2"><i class="fas fa-users"></i> Total User:<label id="totaluser">
                                </label></p>
                        </div>
                        <div class="col-xl-4">
                            <p class="button py-2"><i class="fas fa-user-check"></i> Total Subscribes:<label
                                    id="totalsub">
                                </label></p>
                        </div>
                        <div class="col-xl-4">
                            <p class="button py-2"><i class="fas fa-suitcase-rolling "></i> Total Trip:<label
                                    id="totaltrip">
                                </label></p>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="myusermodal-title" id="myusermodal">Details</h5>
            </div>
            <div class="row">
                <div class="col-md-12">
