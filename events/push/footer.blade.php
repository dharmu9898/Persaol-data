            ...
            <div class="container-fluid">
                ...
                <div class="lgx-footer-area footer-custom-menu">
                    <div class="lgx-footer-single footer-brand">
                        <img class="footer-brand-logo" src="https://www.holidaylandmark.com/events/storage/{{ setting('site.logo') }}" alt="{{ setting('site.site_name') }}" />
                    ...
                    <div class="lgx-footer-single">
                        ...
                        <ul class="list-unstyled">
                           ...
                           <li><a class="col-grey" href="https://www.holidaylandmark.com/india/index.html" target="_blank">@lang('eventmie-pro::em.india')</a></li>
                            <li><a class="col-grey" href="https://www.holidaylandmark.com/blog/" target="_blank">@lang('eventmie-pro::em.blogs')</a></li>
                            <li><a class="col-grey" href="https://www.youtube.com/user/HolidayLandmark" target="_blank">@lang('eventmie-pro::em.video')</a></li>
