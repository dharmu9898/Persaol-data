...
use Classiebit\Eventmie\Models\Myeventticket;
...
class MyEventsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->eventticket  = new Myeventticket;
    ...
    public function eventticket_title()
    {
        $ticket_title = $this->eventticket->get_eventticket();
        log::info('mera  $ticket_title');
        log::info($ticket_title);
        if(empty($ticket_title))
        {
            return response()->json(['status' => false]);    
        }
