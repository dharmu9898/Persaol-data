    ...
    <div style="margin-top:7%;" id="lgx-schedule" class="lgx-schedule lgx-schedule-dark">
        <div style="margin-top:-8%;margin-bottom:-8%;" class="lgx-inner" style="background-image: url({{ asset('img/bg-pattern.png') }});">
            <div class="container-fluid">
                ...
                <div style="margin-bottom:-8%; margin-top: -1%;" class="section-btn-area">
                    <a class="lgx-btn lgx-btn-red" href="{{ route('eventmie.events_index') }}"><i class="fas fa-calendar-day"></i> @lang('eventmie-pro::em.view_all_events')</a>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="lgx-heading" >
                            <h2 class="heading"><i class="fas fa-hourglass-half"></i> @lang('eventmie-pro::em.find_upcoming_events')</h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="lgx-inner" style="background-image: url({{ eventmie_asset('img/bg-pattern.png') }});">
            <div class="container">
                <div class="row" style="margin-top:-10%;">
                    <div class="col-12">
                        <div class="lgx-heading">
                            <h2 class="heading">@lang('eventmie-pro::em.event_cities_events')</h2>
                        </div>
                    </div>
                </div>
                <!--//main row-->
...
<script type="text/javascript">
  $(document).ready(function(){
   ...
   var role = localStorage.getItem("roles_id"); 
   ...
   $("#profileorganiser").show();
    ...
    $("#welcomemytrip").show(); 
    $("#welcomemyevent").show(); 
    console.log('else yahan  logouts logouts');
    var loggedIn={!! json_encode(Auth::check()) !!};
         if(loggedIn){
        var    email = $('#operator_auth_email').val();
        var    role_id = $('#operator_auth_id').val();
        var    name = $('#operator_auth_name').val();
            console.log('all data is here');
            console.log(email);
       
            localStorage.setItem('roles_id', role_id);
