...
use Classiebit\Eventmie\Models\Ticket_title;
...
class Ticket extends Model
{
   ...
   // create and update tickets
    public function add_tickets($params = [], $ticket_id = null)
    {
       ...
       $tick_title= Ticket_title::where('id', $params['ticket_type'])->first();

       $tick_type=$tick_title->ticket_title;
        DB::table("events")->where('id', $event_id)->
    update(array('price_type' => $params['ticket_type'],'ticket_type_name' => $tick_type ));
