                       ...
                       <!-- Only show this to admin -->
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_id" class="form-control" v-model="category_id" v-validate="'required|decimal|is_not:0'" @change="isDirty()">
                                ...
                                <option v-for="(category, index) in categories" :key = "index" :value="category.id">{{category.id}}</option>
                            </select>
...
export default {
    ...
    computed: {
        ...
        slug: function() {
            if(this.title != null)
            {
                 console.warn("my this.slug this.slug: " + this.title)
                var slug = this.sanitizeTitle(this.title);
                 console.warn("my title this.slug: " + slug)
                return slug;
            }
        }
    },
    ...
    methods: {
        ...
        formSubmit(event) {
            ...
            let post_url = route('eventmie.mytrip_store');
            ...
            .then(res => {
                ...
                if(res.data.status)
                {
                    ...
                    {   
                        ...
                        setTimeout(function() {
                            window.location = route('eventmie.mytrips_form',[res.data.slug]);
                        }, 1000);
                    }
                }    
        ...
        getCategories(){
            ...
            .then(res => {
                ...
                if(res.data.status)
                {
                    ...
                    console.log('yeh this.categories');
        ...
        slugUrl(){
            if(this.slug != null)
                return route('eventmie.trips_index').url()+'/'+this.slug;
