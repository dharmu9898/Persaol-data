            ...
            <div class="col-xl-12 col-12 mb-4 mb-xl-0">
                <div class="container-fluid  mt-5 card  border-primary border-primary-5 mb-3">
                    <div class="row card-body">
                        ...
                        <div class="col-xl-4">
                            <p class="button py-2"><i class="fas fa-user-check"></i> Total Subscribes:<label id="totalsub">
                                </label></p>
                        </div>
                        <div class="col-xl-4">
                            <p class="button py-2"><i class="fas fa-suitcase-rolling "></i> Total Trip:<label id="totaltrip">
                                </label></p>
                        </div>
                    </div>
                </div>
