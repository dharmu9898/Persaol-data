                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <div  class="lgx-nav-right navbar-right">
                            <div class="lgx-cart-area">
                                <a class="lgx-btn lgx-btn-sm" href="{{ eventmie_url('allevents') }}"><i
                        ...
                        <div  class="lgx-nav-right navbar-right">
                            <div class="lgx-cart-area">
                                <a class="lgx-btn lgx-btn-sm" href="https://www.holidaylandmark.com/trips"><i
                ...
                <nav class="navbar navbar-default lgx-navbar navbar-expand-lg">
                    <div style="margin-top:-1em; margin-left:-2.3em;" class="navbar-header">
                        ...
                        <div style="margin-top:-1.2em;" class="lgx-logo">
                            <a href="{{ eventmie_url() }}" class="lgx-scroll">
                                <img style="margin-right:-90%;" src="storage/{{ setting('site.logo') }}" />
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul style="margin-top:-2em;" class="nav navbar-nav lgx-nav navbar-right">
                            ...
                            <li>
                                <a class="lgx-scroll"
                                    href="https://www.holidaylandmark.com/india/index.html">Cookbooks</a>
                            </li>
                            ...
                            <li>
                                <a class="lgx-scroll" href=""><i class="fas fa-calendar-plus"></i> Create</a>
                                <ul class="dropdown-menu">
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu multi-level">
                                    ...
                                    <a class="dropdown-item" href="{{ route('eventmie.trips_index') }}"><i
                                            class="fas fa-calendar-alt"></i>
                                        @lang('eventmie-pro::em.manage_trips')</a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('eventmie.visit_index') }}"><i
                                                class="fas fa-calendar-alt"></i>
                                            @lang('eventmie-pro::em.manage_visit_tour')</a>
                                    </li>
                                    ...
                                    <li>
                                        <a class="lgx-scroll" href="{{ route('eventmie.mytrips_form') }}">
                                            <i class="fas fa-calendar-plus"></i>
