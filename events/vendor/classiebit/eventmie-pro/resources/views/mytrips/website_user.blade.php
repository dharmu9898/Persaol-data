            ...
            <div class="col-xl-12 col-12 mb-4 mb-xl-0">
                ...
                <div class="card-body" style="margin-left:1%;">
                    <div class="card-body shadow" style="border-bottom:3px solid red;">
                        <form id="upermission_form" role="form" enctype="multipart/form-data">
                            <div class="table-responsive">
                                <table id="myTable" class="table table-bordered table-striped bg-light"
                                    ...
                                    <thead class="bg-light" style="color:black">
                                        <tr>
                                            ...
                                            <th data-column_name="trip_image" width="15%">User Image</th>
                                            <th data-column_name="trip_title" width="25%">Trip Title</th>
                                            <th data-column_name="trip_country" width="15%">User Name</th>
                                        </tr>
                                    </thead>
                                ...
                                <div class="form-group" align="center">
                                    <input type="hidden" name="upermission_action" id="upermission_action" />
                                ...
                                <input type="submit" name="upermission_action_button" id="upermission_action_button"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h5 style="color:green;" class="tool-modal-title" id="republishModaltouropertor">User Permission Updated
                            successfully </h5>
                    </div>
                </div>
            </div>
...
<script src="{{asset('js/location.js')}}"> </script>
    ...
    $(document).ready(function() {
        ...
        $(function() {
            ...
            $('#upermission_form').on('submit', function(event) {
                ...
                $.ajax({
                    ...
                    url: "{{eventmie_url('admins/upermissiontour')}}/" + email,
                    method: "POST",
            ...
            function fetchData(page, query) {
                ...
                $.ajax({
                    ...
                    url: "{{eventmie_url('admins/userdetail')}}/" + email,
                    type: "GET",
                        ...
                        if (html.data) {
                            ...
                            for (var i = 0; i < dataArr.length; i++) {
                                html += "<tr>" +
                                    ...
                                    dataArr[i].user_image + " class='myimg'/ > </td>" +
                                    "<td>" + dataArr[i].TripHeading	 + "</td>" +
