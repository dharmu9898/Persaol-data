                ...
                <table id="firm_category_table"  style="width: 100%">
                    <thead>
                        <tr>
                            ...
                            <th data-column_name="company_name" width="15%">Category</th>
                            <th data-column_name="location" width="45%">Description</th>
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        let desc = data.length > 6 ? data.substring(0, 50) + ' ...' : data;
                        data =
                            desc;
                        return data;
                    }
