...
Route::get('register/activate/{name}/{activate}/{validToken}', $namespace.'\Auth\RegisterController@showProfileForm')->name('eventmie.register_activates');
...
Route::group([
    ...
    Route::prefix('/events')->group(function () use ($namespace) {
        ...
        Route::get('/', "$controller@index")->name('events');
    ...
    Route::prefix('/myevents')->group(function () use ($namespace) {
        ...
        Route::get('/books', "$controller@book")->name('bookingsmy_index');
        ...
        Route::post('/api/get_mytrip', "$controller@get_user_trip")->name('get_mytrip');
    ...
    Route::prefix('/mytour')->group(function () use ($namespace)  {
        ...
        Route::get('/api/get_mytrips', "$controller@get_mytrips")->name('mytour');
         ...
         Route::get('loginjs/{email}',"$controller@loginjs")->name('loginjs');
        Route::post('/api/get_mytickets', "$controller@mytickets")->name('mytickets');
        Route::post('/api/tripticket_delete', "$tourcontroller@tripticket_delete")->name('tripticket_delete');
    ...
    Route::prefix('/trips')->group(function () use ($namespace) {
        ...
        $tripcontroller = $namespace.'\TourController';
        Route::get('/', "$controller@index")->name('trips');
        Route::get('/alltrips', "$tripcontroller@index")->name('tour_index');
        Route::get('/api/get_trips', "$tripcontroller@events")->name('tour');
    ...
    // Route::get('/logins/{social}', $namespace.'\Auth\LoginController@socialLogin')->where('social', 'facebook|google')->name('oauth_logins');
    // Route::get('/logins/{social}/callback', $namespace.'\Auth\LoginController@handleProviderCallback')->where('social', 'facebook|google')->name('oauth_callbacks');
    ...
    // Route::prefix('/mytrips')->group(function () use ($namespace) {
    //     Route::get('/', $namespace."\WelcomeController@trips")->name('allstrips');
    // });
